...
- 📚 **[分篇学习版/](./分篇学习版/)** —— **按"篇"拆分的学习包**（第零章/第一〜六篇/附录各一文件夹；每篇 `{篇名}-白皮书` / `{篇名}-检测卷合集` / `{篇名}-答案与评分合集`，md 与 PDF 同名；第五/六篇与附录当前仅有白皮书——检测卷尚未命制；共 18 个 PDF / 183 页，窄边距双栏高密度排版，图片全嵌入；命名口径与构建链见 `tools/pdf_build/`）
